    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, verbose_name='groups', help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_query_name='user', related_name='user_set', to='auth.Group')),
                ('user_permissions', models.ManyToManyField(blank=True, verbose_name='user permissions', help_text='Specific permissions for this user.', related_query_name='user', related_name='user_set', to='auth.Permission')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True, serialize=False)),
                ('old_gold', models.DecimalField(default=Decimal('0.0'), verbose_name='积分', max_digits=19, decimal_places=10)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True, serialize=False)),
                ('gold', models.DecimalField(default=Decimal('0.0'), verbose_name='积分', max_digits=19, decimal_places=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pro_gold', models.DecimalField(default=Decimal('0.0'), verbose_name='积分', max_digits=19, decimal_places=10)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='order',
            name='combo',
            field=models.ForeignKey(blank=True, default='', null=True, to='kuaishou_admin.Order_combo'),
        ),
        migrations.AddField(
            model_name='order',
            name='project',
            field=models.ForeignKey(blank=True, default='', null=True, to='kuaishou_admin.Project'),
        ),
        migrations.AddField(
